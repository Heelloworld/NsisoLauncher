...
namespace NsisoLauncher.Windows
{
    ...
    public partial class DownloadWindow : MetroWindow
    {
        ...
        private ChartValues<double> speedValues = new ChartValues<double>() { };
        ...
        {
            if (App.Downloader.ViewDownloadTasks != null)
            {
        ...
        private void Downloader_DownloadProgressChanged(object sender, DownloadProgressChangedArg e)
        {
            this.Dispatcher.Invoke(new Action(() =>
            {
                this.progressBar.Maximum = e.LeftTasksCount + e.DoneTaskCount;
                this.progressBar.Value = e.DoneTaskCount;
                this.progressPerTextBlock.Text = ((double)e.DoneTaskCount / (e.DoneTaskCount + e.LeftTasksCount)).ToString("P");
